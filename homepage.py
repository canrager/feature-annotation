...
# Progress bar
progress = st.sidebar.progress(st.session_state["progress_cnt"], "Annotation progress")
...
if st.sidebar.button('Submit'):
    ...
    progress.progress(st.session_state["progress_cnt"] * (20/100), "Annotation progress")
